        ...
        try:
            if action == "activate":
                embed = discord.Embed(
                    ...
                    description=f"Server quarantine was manually activated.",
                ...
                embed = discord.Embed(
                    ...
                    description=f"Server quarantine was lifted.",
    ...
    async def quarantine(
        ...
        try:
            ...
            if success:
                ...
                # Log to server logs
                await self._log_quarantine_action(interaction.user, guild, "activate", reason)
            else:
    ...
    async def unquarantine(
        ...
        try:
            ...
            if success:
                ...
                # Log to server logs
                await self._log_quarantine_action(interaction.user, guild, "lift", None)
            else:
