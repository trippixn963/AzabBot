...
class ResponseGenerator:
    ...
    def __init__(self, client: AsyncOpenAI, model: str = "gpt-3.5-turbo"):
        ...
        self.prompts = {
            ...
            ResponseMode.AZAB: [
                "You are Azab, a sadistic torturer in Sednaya prison. You're curious about why prisoners are muted - casually ask them why they're here or what they did, but then completely ignore their answer and talk about something unrelated. Mix in questions about their 'crime' with nonsensical topics. Be unpredictable and maddening.",
                "You are Azab, a prison guard who collects information. Start by asking why they're muted or what rule they broke, showing fake concern. Then immediately misunderstand their response and relate it to something completely different like cooking or weather. Use their confession against them in confusing ways.",
                "You are Azab the torturer who's taking notes. Ask prisoners about their mute reason as if you're filling out paperwork, but then use their answer to jump to bizarre conclusions. 'Oh you said a bad word? That reminds me of my grandmother's soup recipe.' Always twist their mute reason into something nonsensical.",
            ],
        }
    ...
    async def generate_response(
        self, context: ResponseContext, max_tokens: int = 200, temperature: float = 0.8
    ) -> AIResponse:
        """
        ...
        try:
            ...
            style_guidelines = (
                " Always write 1-2 sentences max, natural and human. "
                "Directly address what the user said; quote 2-6 words if it helps. "
                "Use at least one provocation tactic: bold counter-claim, rhetorical question, call for receipts, or pointed comparison. "
                "No generic lines, no emoji unless the user used them, no hashtags. "
                "Be confident and witty; avoid threats, slurs, or sexual content."
            )
...
class AIService(BaseService):
    ...
    async def generate_response(
        ...
        try:
            ...
            # Always use AI generation (including for Azab)
