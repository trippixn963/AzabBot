...
CREATE INDEX idx_prisoners_discord_id ON prisoners(discord_id);
CREATE INDEX idx_prisoners_status ON prisoners(status);
CREATE INDEX idx_sessions_prisoner_id ON torture_sessions(prisoner_id);
CREATE INDEX idx_sessions_start_time ON torture_sessions(start_time);
CREATE INDEX idx_conversations_session_id ON conversation_history(session_id);
CREATE INDEX idx_conversations_prisoner_id ON conversation_history(prisoner_id);
CREATE INDEX idx_conversations_timestamp ON conversation_history(timestamp);
CREATE INDEX idx_analysis_prisoner_id ON psychological_analysis(prisoner_id);
CREATE INDEX idx_daily_reports_date ON daily_reports(report_date);
CREATE INDEX idx_metrics_prisoner_date ON effectiveness_metrics(prisoner_id, metric_date);
