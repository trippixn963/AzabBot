...
class TestAIService:
    ...
    async def test_analyze_personality(self):
        ...
        mock_response.choices = [
            MagicMock(
                message=MagicMock(content="anxious, defensive, confused")
            )
        ]
        ...
        with patch.object(service, "_openai_client") as mock_client:
            ...
            history = [
                ...
                {
                    "role": "assistant",
                    "content": "Tell me about what happened.",
                },
    ...
    async def test_concurrent_requests(self):
        ...
        mock_response = MagicMock()
        mock_response.choices = [
            MagicMock(message=MagicMock(content="Concurrent response"))
        ]
        with patch.object(service, "_openai_client") as mock_client:
            mock_client.chat.completions.create = AsyncMock(
                return_value=mock_response
            ...
            contexts = [ConversationContext(i, f"User{i}") for i in range(5)]
