...
class TicketService(AutoCloseMixin, HelpersMixin, OperationsMixin):
    ...
    async def _recover_pending_deletions(self) -> int:
        ...
        for ticket in closed_tickets:
            ...
            try:
                ...
                logger.debug("Ticket Deletion Recovered", [
                    ("Ticket", ticket_id),
        ...
        for ticket in open_tickets:
            try:
                ...
                if ticket["status"] == "claimed" and ticket.get("claimed_by"):
                    ...
                    # Ticket was unclaimed - notify staff with ticket roles
                    from src.services.tickets.buttons.helpers import _get_ticket_staff_members
                    staff_members = _get_ticket_staff_members(self.config, member.guild)
                    for staff in staff_members:
                        if staff not in users_to_notify:
    ...
    async def _send_staff_summary(
        ...
        ping_content = self._staff_ping or ""
